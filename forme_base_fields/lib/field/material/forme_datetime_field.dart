...
class _FormeDateTimeFieldState extends FormeFieldState<DateTime?> {
  ...
  @override
  void onStatusChanged(FormeFieldChangedStatus<DateTime?> status) {
    super.onStatusChanged(status);
    if (status.isValueChanged) {
      textEditingController.text =
          status.value == null ? '' : _formatter(widget.type, status.value!);
    }
  }
  ...
  @override
  void didUpdateWidget(covariant FormeField<DateTime?> oldWidget) {
