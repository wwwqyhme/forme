...
class _FormeCupertinoTimerFieldState extends FormeFieldState<Duration?> {
  ...
  @override
  void onStatusChanged(FormeFieldChangedStatus<Duration?> status) {
    super.onStatusChanged(status);
    if (status.isValueChanged) {
      textEditingController.text =
          status.value == null ? '' : _formatter(status.value!, widget.mode);
    }
  }
  ...
  @override
  void didUpdateWidget(covariant FormeField<Duration?> oldWidget) {
